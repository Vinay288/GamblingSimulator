...
public class GamblingSimulator {
	...
	public static int luckiestMonth = -1, unLuckiestMonth = -1, maxProfit = 0, maxLoss = Integer.MAX_VALUE;
	...
	static void gambleForOneYear() {
		...
		for (int j = 0; j < 12; j++) {
			...
			calculateLuckiestAndUnlukiestMonth(totalWinDays, totalLossDays, j);
	...
	static void calculateLuckiestAndUnlukiestMonth(int totalWin, int totalLoss, int j) {
